...
// Validate ../../src/app/api/example-tournament/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/example-tournament">> = Specific
  const handler = {} as typeof import("../../src/app/api/example-tournament/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
